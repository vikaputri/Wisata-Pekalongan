...
import Oleholeh_QUERY from "../../queries/gifts/gift";
          ...
          <div className="col-md-8">
            <div className="card mb-4">
              <div className="card-body">
                <Query query={Oleholeh_QUERY} slug={id}>
                  {({ data: { oleholeh } }) => {
                    const imageUrl = oleholeh.image;
                    return (
                      <div className="container px-5 py-5">
                        <div className="jumbotron"> 
                          ...
                          <div className="mb-5">
                            {ReactHtmlParser(oleholeh.content)}
                          </div>
                        </div>
                          ...
                          <StickyShareButtons
                            config={{
                              ...
                              image: imageUrl,
                              description: oleholeh.description,
